...
export class ITranslatorTextarea extends HTMLElement {
  connectedCallback() {
    ...
    const documentControls = this.querySelector('.itarea__document-controls');
    const modeTab = this.querySelector('.itarea__mode-tab');
    controlBar.insertBefore(settingsButton, controlBar.firstChild);
    controlBar.insertBefore(documentControls, modeButtons);
    modeTab.hidden = true;
