...
const collapseControlsIcon = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m7.41 18.59L12 14l4.59 4.59L18 17.17l-6-6-6 6Zm0-13.18L6 6.83l6 6 6-6-1.41-1.42L12 10 7.41 5.41Z"/></svg>';
const expandControlsIcon = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5.83 15.17 9l1.41-1.41L12 3 7.41 7.59 8.83 9 12 5.83Zm0 12.34L8.83 15l-1.41 1.41L12 21l4.59-4.59L15.17 15 12 18.17Z"/></svg>';
